...
const questions = [
    ...
    {
        question: "What is the default type assigned to variables in TypeScript if not specified?",
    ...
    },
    {
        ...
        correctAnswer: "For variables that can hold any value, but must be checked before using",
    },
    {
        question: "Which TypeScript feature allows you to create a new type from an existing type with some modifications?",
...
console.log(chalk.blue(`Your final score is ${score} out of ${questions.length}.`));
